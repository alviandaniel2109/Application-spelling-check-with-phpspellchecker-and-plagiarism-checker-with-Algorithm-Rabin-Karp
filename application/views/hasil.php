<div class="bs-example" data-example-id="simple-responsive-table" style="padding: 25px 10px 25px 39px;">
  <div class="table-responsive">
    ...
    <h2 id="tables-hover-rows">Pre Processing</h2>
    <table class="table">
      <thead>
        <tr>
          <th>#</th>
  ...
  <a href="<?php echo base_url()."index.php/check_plagiarism/report/" . $key . "/" . $gram . "/" . $basis  ?>">
    <button class="btn btn-info btn-lg" type="button" style="margin-left: 1px;">Report</button>
  </a>
</div>