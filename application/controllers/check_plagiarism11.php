...
class check_plagiarism extends CI_Controller {
    ...
    public function hasil($key)
    {
        ...
        // $data['a'] = $this->plagrismemodel->count_a();
        // $data['b'] = $this->plagrismemodel->count_b();
        // $data['x'] = $this->plagrismemodel->count_ab();
        // $data['c'] = $this->plagrismemodel->count_c();
        // $data['xx'] = $this->plagrismemodel->count_ac();
        $data['viewpage'] = 'hasil';
